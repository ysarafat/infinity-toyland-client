        ...
        <div className="my-16">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mt-10 bg-[#f1f5f9] p-4 border border-slate-200 rounded-lg">
                <img
                    ...
                    className="h-[180px] lg:h-[300px]  w-full rounded"
                ...
                <img
                    ...
                    data-aos-duration="800"
                    className="col-span-2 h-[300px] lg:h-[500px] w-full rounded"
                ...
                <img
                    ...
                    data-aos-duration="800"
                    className=" lg:col-span-2  h-[180px]  lg:h-[500px] w-full rounded"
                ...
                <img
                    data-aos="zoom-in"
                    data-aos-duration="800"
                    className=" col-span-2 lg:col-span-1 h-[180px] lg:h-[300px] w-full rounded"
